...
class BottomNavigationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => BottomNavigationBar(
          ...
          selectedItemColor: const Color.fromRGBO(76, 61, 59, 1),
          unselectedItemColor: const Color.fromRGBO(128, 128, 128, 1),
          unselectedLabelStyle: textStyleData(12, 400, 12, [128, 128, 128, 1]),
          selectedLabelStyle: textStyleData(12, 400, 12, [76, 61, 59, 1]),
                ...
                icon: Padding(
                  ...
                  child: SvgPicture.asset("assets/home.svg",
                      ...
                      color: _controller.currentIndex.value == 0
                          ? const Color.fromRGBO(39, 29, 28, 1)
                ...
                icon: Padding(
                  ...
                  child: SvgPicture.asset("assets/settting.svg",
                      ...
                      color: _controller.currentIndex.value == 3
                          ? const Color.fromRGBO(39, 29, 28, 28)
                          : const Color.fromRGBO(128, 128, 128, 1)),
                ),
                label: "Settings"),
          ],
