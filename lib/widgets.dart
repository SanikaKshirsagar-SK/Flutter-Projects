...
Container customTextField(String hintText, {
  ...
  return Container(
    ...
    child: TextField(
        ...
        decoration: InputDecoration(
            labelText: label,
            labelStyle: label != null ? textStyleData(12, 400, 18, [0, 0, 0, 0.4]) : null,
            hintText: hintText,
...
Container customTextFormField(String hintText, {
  required TextEditingController controller,
  String? label,
  bool obscureText = false,
...
SizedBox customButtonReorder(
  ...
  return SizedBox(
    ...
    child: ElevatedButton(
        ...
        onPressed: onPressed,
        child: Text(buttonText,
            style: textStyleData(18, 400, 18, textColor ?? [255, 122, 0, 1]))),
  );
}
      ...
      child: Transform.translate(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: const Color.fromRGBO(255, 122, 0, 0.8), // Orange color
